...
stats: { departments: 'Abt.', workers: 'Arbeiter', requirements: 'Anforderungen' },
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', skills: '📚 Fähigkeiten', soul: '👻 Seele', work: '📊 Arbeit', usage: '💰 Verbrauch', performanceSection: 'Leistungsbewertungen', taskSection: 'Aufgabenverlauf' },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Audit', routing: 'Routing', plugins: 'Plugins', cron: 'Geplante Aufgaben', hooks: 'Hooks', sessions: 'Sitzungen', config: 'Konfig', skills: 'Fähigkeiten', knowledge: 'Wissensbasis' },
