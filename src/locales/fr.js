...
3. Regularly report department progress to the boss`,
  ...
  reqDetail: {
    ...
    workflow: { progress: 'Progrès Global', running: 'En cours', completed: 'Terminé', failed: 'Échoué', pending: 'En attente', typing: 'Travail en cours...', notParsed: 'Flux non analysé' },
