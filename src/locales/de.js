...
typing: 'Tippt...', thinking: 'Denkt nach...', inputPlaceholder: '{name} etwas sagen...',
...
loadingOlder: 'Ältere Nachrichten laden...', noMoreHistory: 'Keine weiteren Nachrichten', scrollToBottom: 'Zum Neuesten springen', newMessages: 'Neue Nachrichten ↓', toolIteration: 'Schritt {current}/{max}', toolMore: 'weitere', toolCallArgs: 'Argumente:', toolCallResult: 'Ergebnis:', toolCallError: 'Fehler:',
  ...
  requirements: {
    ...
    createBtn: 'Neue Anforderung',
    noDeptHint: 'Erstellen Sie zuerst eine Abteilung, bevor Sie Anforderungen hinzufügen',
    createTitle: 'Anforderung erstellen',
    createFirstBtn: 'Erste Anforderung erstellen',
    stats: { all: 'Alle', inProgress: 'In Arbeit', completed: 'Fertig', failed: 'Fehlgeschlagen' },
    empty: 'Keine Anforderungen',
    emptyHint: 'Klicken Sie oben, um Ihre erste Anforderung zu erstellen, oder chatten Sie mit dem Sekretär!',
    noMatchTitle: 'Keine passenden Anforderungen',
    noMatchHint: 'Versuchen Sie, Suchbegriffe oder Filter anzupassen',
    searchPlaceholder: 'Nach Titel, Beschreibung oder Abteilung suchen...',
    showingCount: '{n} von {total} angezeigt',
    guide: {
      step1Title: 'Abteilung erstellen',
      step1Desc: 'Richten Sie eine Abteilung mit den richtigen Teammitgliedern ein.',
      step2Title: 'Anforderung erstellen',
      step2Desc: 'Beschreiben Sie, was Sie brauchen — das AI-Team plant und führt den Workflow automatisch aus.',
      step3Title: 'Verfolgen & Prüfen',
      step3Desc: 'Überwachen Sie den Fortschritt in Echtzeit, prüfen Sie Ergebnisse und genehmigen Sie abgeschlossene Arbeit.',
    },
    deptLabel: 'Abteilung',
    deptPlaceholder: 'Abteilung auswählen...',
    membersUnit: 'Mitglieder',
    titleLabel: 'Titel',
    titlePlaceholder: 'z.B. Landingpage für das neue Produkt erstellen',
    descLabel: 'Beschreibung',
    descPlaceholder: 'Beschreiben Sie die Anforderung detailliert — je mehr Kontext, desto besser...',
    workspaceDirLabel: 'Arbeitsverzeichnis (optional)',
    workspaceDirPlaceholder: 'z.B. /Users/you/projects/my-app',
    workspaceDirHint: 'Geben Sie ein lokales Verzeichnis für Datei-E/A an. Leer lassen für Standard-Arbeitsbereich.',
    browseTitle: 'Verzeichnis durchsuchen',
    emptyDir: 'Dieses Verzeichnis ist leer',
    selectDir: 'Dieses Verzeichnis auswählen',
    creating: 'Erstellen...',
    submitBtn: 'Erstellen & Starten',
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', profile: '🎨 Profil', skills: '📚 Fähigkeiten', soul: '👻 Seele', work: '📊 Arbeit', usage: '💰 Verbrauch', llmLogs: '🔍 LLM-Logs', performanceSection: 'Leistungsbewertungen', taskSection: 'Aufgabenverlauf' },
    ...
    noSkills: 'Keine Fähigkeiten zugewiesen', manageSkills: 'Fähigkeiten verwalten',
    skillsDescription: 'Fähigkeiten aktivieren/deaktivieren. Angepinnte Fähigkeiten sind immer aktiv.',
    skillPin: 'Anpinnen', skillUnpin: 'Lösen', legacySkills: 'Legacy-Fähigkeiten', skillsLoadError: 'Fehler beim Laden der Fähigkeiten',
    ...
    promptHint: 'Die Rollenbeschreibung und Anweisungen, die die Aufgaben dieses Mitarbeiters definieren',
    customPromptLabel: 'Benutzerdefinierte Anweisungen',
    customPromptPlaceholder: 'Fügen Sie spezielle Anweisungen für diesen Mitarbeiter hinzu (z.B. „Immer auf Deutsch antworten", „Fokus auf Backend-Aufgaben")...',
    customPromptHint: 'Zusätzliche Anweisungen werden in den System-Prompt eingespeist — beeinflusst Denken und Antwortverhalten',
    saveConfig: 'Änderungen speichern',
    saving: 'Speichern...',
    ...
    profileName: 'Name',
    profileNamePlaceholder: 'z.B. Alice, Bob',
    avatarStyle: 'Avatar-Stil',
    refreshAvatar: 'Mischen',
    signatureLabel: 'Signatur',
    signaturePlaceholder: 'z.B. Effizienz ist Leben',
    saveProfile: 'Profil speichern',
    profileSaved: 'Profil gespeichert!',
    profileSaveFailed: 'Profil konnte nicht gespeichert werden',
    llmLogs: {
      empty: 'Keine LLM-Aufrufprotokolle',
      emptyHint: 'Im Dev-Modus werden Logs aufgezeichnet, wenn dieser Mitarbeiter LLM-Aufrufe durchführt',
      totalCount: '{n} Protokolleinträge',
      refresh: 'Aktualisieren',
      clear: 'Alle löschen',
      clearConfirm: 'Alle LLM-Logs dieses Mitarbeiters löschen? Dies kann nicht rückgängig gemacht werden.',
      input: 'Eingabe',
      output: 'Ausgabe',
      toolDefs: 'Tool-Definitionen',
      loadError: 'Fehler beim Laden der Log-Details',
    },
    stamina: {
  ...
  secretarySettings: {
    ...
    tabProfile: '👤 Profil', tabSoul: '🧠 Seele', tabLLMLogs: '🔍 LLM-Logs',
  ...
  reqDetail: {
    ...
    action: {
      analyzingRequirement: '{name} analysiert und zerlegt die Anforderung...',
      analyzingSprint: '{name} analysiert und zerlegt den Sprint-Plan...',
      bossStop: 'Boss hat Stopp angefordert, Projekt angehalten',
      rePlanning: '{name} plant den Workflow nach den Anweisungen des Bosses neu...',
      bossApproved: 'Boss hat genehmigt — Anforderung abgeschlossen',
      executionStarted: 'Workflow-Ausführung gestartet',
      preparing: '{name} bereitet die Ausführung von „{title}" vor',
      typing: '{name} tippt... „{title}"',
      workingViaCli: '{name} arbeitet über {backend}... ({elapsed}s vergangen)',
      callingTool: '{name} ruft Werkzeug {tool} auf',
      cliCompleted: '{name} hat Arbeit über {backend} abgeschlossen (Exit-Code: {exitCode})',
      toolCompleted: '{name} hat Werkzeugaufruf {tool} abgeschlossen',
      typingRound: '{name} tippt... (Runde {iteration})',
      reviewing: '{name} überprüft „{title}" (Runde {rounds})',
      revising: '{name} überarbeitet „{title}" basierend auf Review-Feedback (Runde {rounds})',
      revisionCallingTool: '{name} (Überarbeitung) ruft {tool} auf',
      revisingIteration: '{name} überarbeitet... (Iteration {iteration})',
      revisingAfterDiscussion: '{name} überarbeitet „{title}" nach Diskussion (Runde {rounds})',
      revisingAfterDiscussionIteration: '{name} überarbeitet nach Diskussion... (Iteration {iteration})',
      allFailed: 'Ausführung beendet (alle Aufgaben fehlgeschlagen)',
      awaitingApproval: 'Alle Aufgaben erledigt — warte auf Boss-Genehmigung',
    },
  },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Audit', routing: 'Routing', plugins: 'Plugins', cron: 'Geplante Aufgaben', hooks: 'Hooks', sessions: 'Sitzungen', config: 'Konfig', skills: 'Fähigkeiten', knowledge: 'Wissensbasis', channels: 'Kanäle' },
    ...
    skillStats: { total: 'Gesamt', enabled: 'Aktiviert', categories: 'Kategorien', installed: 'Installiert', custom: 'Benutzerdefiniert' },
    channelStats: { available: 'Verfügbar', installed: 'Installiert', connected: 'Verbunden', messages: 'Nachrichten' },
    channelState: { installed: 'Installiert', configured: 'Konfiguriert', connecting: 'Verbinden', connected: 'Verbunden', disconnected: 'Getrennt', error: 'Fehler' },
    channelActions: { install: 'Installieren', connect: 'Verbinden', disconnect: 'Trennen', confirmUninstall: 'Möchten Sie diesen Kanal wirklich deinstallieren?' },
    channelSection: { availableTitle: 'Verfügbare Kanäle', noAdapters: 'Keine Kanaladapter registriert', guideTitle: 'Einrichtungsanleitung', guideStep1: 'Klicken Sie auf "Installieren" beim gewünschten Kanal', guideStep2: 'Kanaleinstellungen konfigurieren (optional)', guideStep3: 'Klicken Sie auf "Verbinden", um den Kanal zu starten', guideStep4: 'Für WeChat: QR-Code mit dem Handy scannen, um sich anzumelden' },
    channelConfig: { title: '{name} konfigurieren', autoReply: 'Automatisch auf Nachrichten antworten' },
qrLogin: { title: 'WeChat QR-Login', instruction: 'Scannen Sie den QR-Code unten mit WeChat auf Ihrem Smartphone, um sich anzumelden', success: 'Anmeldung erfolgreich! WeChat ist jetzt verbunden.', scanned: 'QR-Code gescannt — bitte auf dem Smartphone bestätigen', waiting: 'Warten auf QR-Code-Scan...', generating: 'QR-Code wird generiert...', openedInBrowser: 'Die QR-Code-Seite wurde in einem neuen Browserfenster geöffnet. Bitte scannen Sie mit WeChat.', openQrPage: 'QR-Code-Seite erneut öffnen' },
    ...
    skillDetail: { noSkills: 'Keine Fähigkeiten', noCustom: 'Keine benutzerdefinierten Fähigkeiten', noCustomHint: 'Erstellen Sie Fähigkeiten in Markdown, um das Agentenverhalten anzupassen' },
    skillTabs: { all: 'Alle', custom: 'Benutzerdefiniert', marketplace: 'Marktplatz' },
    skillActions: { create: 'Erstellen', edit: 'Bearbeiten', markdownHint: 'Schreiben Sie in Markdown mit YAML Frontmatter (name, description, category, icon, tags)' },
    skillMarketplace: { searchPlaceholder: 'Auf ClawHub suchen...', install: 'Installieren', installed: 'Installiert', installedTitle: 'Vom Marktplatz installiert', empty: 'Keine Marktplatz-Fähigkeiten', emptyHint: 'Durchsuchen Sie ClawHub, um Community-Fähigkeiten zu entdecken und zu installieren' },
  ...
  api: {
    ...
    missingParameter: 'Pflichtparameter fehlt: {param}',
