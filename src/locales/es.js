...
typing: 'Escribiendo...', thinking: 'Pensando...', inputPlaceholder: 'Dile algo a {name}...',
...
loadingOlder: 'Cargando mensajes anteriores...', noMoreHistory: 'No hay más mensajes', scrollToBottom: 'Ir al último', newMessages: 'Nuevos mensajes ↓', toolIteration: 'Paso {current}/{max}', toolMore: 'más', toolCallArgs: 'Argumentos:', toolCallResult: 'Resultado:', toolCallError: 'Error:',
  ...
  requirements: {
    ...
    createBtn: 'Nuevo Requisito',
    noDeptHint: 'Crea un departamento primero antes de agregar requisitos',
    createTitle: 'Crear Requisito',
    createFirstBtn: 'Crea Tu Primer Requisito',
    stats: { all: 'Todos', inProgress: 'En Progreso', completed: 'Completados', failed: 'Fallidos' },
    empty: 'Sin requisitos',
    emptyHint: '¡Haz clic arriba para crear tu primer requisito, o chatea con el secretario para asignar tareas!',
    noMatchTitle: 'Sin requisitos coincidentes',
    noMatchHint: 'Intenta ajustar las palabras clave o los filtros',
    searchPlaceholder: 'Buscar por título, descripción o departamento...',
    showingCount: 'Mostrando {n} de {total}',
    guide: {
      step1Title: 'Crear Departamento',
      step1Desc: 'Configura un departamento con los miembros adecuados para manejar tus tareas.',
      step2Title: 'Crear Requisito',
      step2Desc: 'Describe lo que necesitas — el equipo de IA planificará y ejecutará el flujo de trabajo automáticamente.',
      step3Title: 'Seguir y Revisar',
      step3Desc: 'Monitorea el progreso en tiempo real, revisa resultados y aprueba el trabajo completado.',
    },
    deptLabel: 'Departamento',
    deptPlaceholder: 'Seleccionar departamento...',
    membersUnit: 'miembros',
    titleLabel: 'Título',
    titlePlaceholder: 'ej. Construir una página de aterrizaje para el nuevo producto',
    descLabel: 'Descripción',
    descPlaceholder: 'Describe el requisito en detalle — cuanto más contexto, mejor el resultado...',
    workspaceDirLabel: 'Directorio de Trabajo (opcional)',
    workspaceDirPlaceholder: 'ej. /Users/you/projects/my-app',
    workspaceDirHint: 'Especifica un directorio local para operaciones de archivo. Deja vacío para usar el espacio predeterminado.',
    browseTitle: 'Explorar Directorio',
    emptyDir: 'Este directorio está vacío',
    selectDir: 'Seleccionar Este Directorio',
    creating: 'Creando...',
    submitBtn: 'Crear e Iniciar',
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', profile: '🎨 Perfil', skills: '📚 Habilidades', soul: '👻 Alma', work: '📊 Trabajo', usage: '💰 Consumo', llmLogs: '🔍 Logs LLM', performanceSection: 'Evaluaciones de rendimiento', taskSection: 'Historial de tareas' },
    soulSections: { memory: '🧠 Memoria', stamina: '🔋 Resistencia', config: '⚙️ Configuración' },
    memorySubTabs: { personal: '💭 Personal', social: '👥 Relaciones' },
    avgPerformance: 'Rendimiento promedio {score}', rolePrompt: 'Prompt del Rol', personalityBio: 'Perfil de Personalidad', skills: 'Habilidades',
    noSkills: 'Sin habilidades asignadas', manageSkills: 'Gestionar Habilidades',
    skillsDescription: 'Activar o desactivar habilidades. Las habilidades fijadas están siempre activas.',
    skillPin: 'Fijar habilidad', skillUnpin: 'Desfijar', legacySkills: 'Habilidades heredadas', skillsLoadError: 'Error al cargar habilidades',
    ...
    providerLabel: 'Proveedor de modelo',
    providerHint: 'Cambia el cerebro IA que impulsa a este empleado',
    promptLabel: 'Prompt de rol',
    promptHint: 'La descripción del rol e instrucciones que definen el trabajo de este empleado',
    customPromptLabel: 'Instrucciones personalizadas',
    customPromptPlaceholder: 'Añade instrucciones especiales para este empleado (ej. "Siempre responder en español formal", "Enfocarse en tareas backend")...',
    customPromptHint: 'Instrucciones extra inyectadas en el prompt del sistema — afectan cómo piensa y responde este empleado',
    saveConfig: 'Guardar cambios',
    saving: 'Guardando...',
    configSaved: '¡Configuración guardada!',
    configSaveFailed: 'Error al guardar',
    noProviders: 'No hay proveedores disponibles',
    editProfile: 'Editar perfil',
    profileName: 'Nombre',
    profileNamePlaceholder: 'ej. Alice, Bob',
    avatarStyle: 'Estilo de avatar',
    refreshAvatar: 'Mezclar',
    signatureLabel: 'Firma',
    signaturePlaceholder: 'ej. La eficiencia es vida',
    saveProfile: 'Guardar perfil',
    profileSaved: '¡Perfil guardado!',
    profileSaveFailed: 'Error al guardar el perfil',
    llmLogs: {
      empty: 'Sin registros de llamadas LLM',
      emptyHint: 'En modo desarrollo, se registran los logs cuando este empleado realiza llamadas LLM',
      totalCount: '{n} registros',
      refresh: 'Actualizar',
      clear: 'Borrar todo',
      clearConfirm: '¿Borrar todos los logs LLM de este empleado? No se puede deshacer.',
      input: 'Entrada',
      output: 'Salida',
      toolDefs: 'Definiciones de herramientas',
      loadError: 'Error al cargar los detalles del log',
    },
    stamina: {
      noData: 'Sin datos de resistencia',
      comfort: 'Comodidad',
      patience: 'Paciencia',
      fatigue: 'Fatiga',
      stress: 'Estrés',
      zone_green: 'Normal — funcionando a plena capacidad',
      zone_yellow: 'Cauteloso — ajustando estrategia, energía baja',
      zone_red: 'Crítico — necesita descanso o cambio de enfoque',
      formula: 'Comodidad = Paciencia - (Fatiga × 0,4 + Estrés × 0,6)',
      recentEvents: 'Eventos recientes',
      noEvents: 'Sin eventos de resistencia registrados',
    },
  },
  orgTree: {
  ...
  secretarySettings: {
    ...
    tabProfile: '👤 Perfil', tabSoul: '🧠 Alma', tabLLMLogs: '🔍 Logs LLM',
  ...
  reqDetail: {
    ...
    action: {
      analyzingRequirement: '{name} está analizando y descomponiendo el requisito...',
      analyzingSprint: '{name} está analizando y descomponiendo el plan de sprint...',
      bossStop: 'El jefe solicitó detener, proyecto detenido',
      rePlanning: '{name} está replanificando el flujo de trabajo según las instrucciones del jefe...',
      bossApproved: 'El jefe aprobó — requisito completado',
      executionStarted: 'Ejecución del flujo de trabajo iniciada',
      preparing: '{name} se está preparando para ejecutar "{title}"',
      typing: '{name} está escribiendo... "{title}"',
      workingViaCli: '{name} está trabajando vía {backend}... ({elapsed}s transcurridos)',
      callingTool: '{name} está llamando a la herramienta {tool}',
      cliCompleted: '{name} completó el trabajo vía {backend} (código de salida: {exitCode})',
      toolCompleted: '{name} completó la llamada a {tool}',
      typingRound: '{name} está escribiendo... (ronda {iteration})',
      reviewing: '{name} está revisando "{title}" (ronda {rounds})',
      revising: '{name} está revisando "{title}" según los comentarios (ronda {rounds})',
      revisionCallingTool: '{name} (revisión) llamando a {tool}',
      revisingIteration: '{name} está revisando... (iteración {iteration})',
      revisingAfterDiscussion: '{name} está revisando "{title}" tras la discusión (ronda {rounds})',
      revisingAfterDiscussionIteration: '{name} está revisando tras la discusión... (iteración {iteration})',
      allFailed: 'Ejecución finalizada (todas las tareas fallaron)',
      awaitingApproval: 'Todas las tareas completadas — esperando aprobación del jefe',
    },
  },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Auditoría', routing: 'Enrutamiento', plugins: 'Plugins', cron: 'Tareas Programadas', hooks: 'Hooks', sessions: 'Sesiones', config: 'Config', skills: 'Habilidades', knowledge: 'Base de Conocimiento', channels: 'Canales' },
    ...
    skillStats: { total: 'Total', enabled: 'Habilitados', categories: 'Categorías', installed: 'Instalados', custom: 'Personalizados' },
    channelStats: { available: 'Disponibles', installed: 'Instalados', connected: 'Conectados', messages: 'Mensajes' },
    channelState: { installed: 'Instalado', configured: 'Configurado', connecting: 'Conectando', connected: 'Conectado', disconnected: 'Desconectado', error: 'Error' },
    channelActions: { install: 'Instalar', connect: 'Conectar', disconnect: 'Desconectar', confirmUninstall: '¿Seguro que desea desinstalar este canal?' },
    channelSection: { availableTitle: 'Canales Disponibles', noAdapters: 'No hay adaptadores de canal registrados', guideTitle: 'Guía de Configuración', guideStep1: 'Haga clic en "Instalar" en el canal deseado', guideStep2: 'Configurar los ajustes del canal (opcional)', guideStep3: 'Haga clic en "Conectar" para iniciar el canal', guideStep4: 'Para WeChat: escanee el código QR con su teléfono para iniciar sesión' },
    channelConfig: { title: 'Configurar {name}', autoReply: 'Responder automáticamente a mensajes' },
qrLogin: { title: 'Inicio de sesión WeChat por QR', instruction: 'Escanee el código QR a continuación con WeChat en su teléfono para iniciar sesión', success: '¡Inicio de sesión exitoso! WeChat está ahora conectado.', scanned: 'Código QR escaneado — por favor confirme en su teléfono', waiting: 'Esperando escaneo del código QR...', generating: 'Generando código QR...', openedInBrowser: 'La página del código QR se ha abierto en una nueva ventana del navegador. Escanee con WeChat.', openQrPage: 'Reabrir página del código QR' },
    ...
    skillDetail: { noSkills: 'Sin habilidades', noCustom: 'Sin habilidades personalizadas', noCustomHint: 'Crea habilidades con Markdown para personalizar el comportamiento del agente' },
    skillTabs: { all: 'Todas', custom: 'Personalizadas', marketplace: 'Marketplace' },
    skillActions: { create: 'Crear Habilidad', edit: 'Editar Habilidad', markdownHint: 'Escribe en Markdown con YAML frontmatter (name, description, category, icon, tags)' },
    skillMarketplace: { searchPlaceholder: 'Buscar en ClawHub...', install: 'Instalar', installed: 'Instalado', installedTitle: 'Instalados del Marketplace', empty: 'Sin habilidades del marketplace', emptyHint: 'Busca en ClawHub para descubrir e instalar habilidades de la comunidad' },
  ...
  api: {
    ...
    missingParameter: 'Falta parámetro requerido: {param}',
