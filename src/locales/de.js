...
3. Regularly report department progress to the boss`,
  ...
  reqDetail: {
    ...
    workflow: { progress: 'Gesamtfortschritt', running: 'Läuft', completed: 'Fertig', failed: 'Fehlgeschlagen', pending: 'Ausstehend', typing: 'Arbeitet...', notParsed: 'Workflow nicht analysiert' },
