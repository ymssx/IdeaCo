...
stats: { departments: '부서', workers: '직원', requirements: '요구사항' },
  ...
  agent: {
    ...
    tabs: { info: '📋 기본 정보', skills: '📚 스킬', soul: '👻 영혼', work: '📊 업무', usage: '💰 소비', performanceSection: '성과 평가', taskSection: '작업 이력' },
  ...
  systemSettings: {
    ...
    cards: { audit: '보안 감사', routing: '라우팅', plugins: '플러그인', cron: '예약 작업', hooks: '이벤트 훅', sessions: '세션', config: '설정', skills: '스킬', knowledge: '나레지 베이스' },
