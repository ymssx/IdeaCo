...
loadingOlder: '이전 메시지 불러오는 중...', noMoreHistory: '더 이상 메시지가 없습니다', scrollToBottom: '최신으로 이동', newMessages: '새 메시지 ↓', toolIteration: '{current}/{max} 단계', toolMore: '더 보기', toolCallArgs: '인수:', toolCallResult: '결과:', toolCallError: '오류:',
  ...
  agent: {
    ...
    tabs: { info: '📋 기본 정보', profile: '🎨 프로필', skills: '📚 스킬', soul: '👻 영혼', work: '📊 업무', usage: '💰 소비', llmLogs: '🔍 LLM로그', performanceSection: '성과 평가', taskSection: '작업 이력' },
    ...
    editProfile: '프로필 편집',
    profileName: '이름',
    profileNamePlaceholder: '예: 앨리스, 밥',
    avatarStyle: '아바타 스타일',
    refreshAvatar: '셔플',
    signatureLabel: '서명',
    signaturePlaceholder: '예: 효율이 생명이다',
    saveProfile: '프로필 저장',
