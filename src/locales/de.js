...
typing: 'Tippt...', thinking: 'Denkt nach...', inputPlaceholder: '{name} etwas sagen...',
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', skills: '📚 Fähigkeiten', soul: '👻 Seele', work: '📊 Arbeit', usage: '💰 Verbrauch', llmLogs: '🔍 LLM-Logs', performanceSection: 'Leistungsbewertungen', taskSection: 'Aufgabenverlauf' },
