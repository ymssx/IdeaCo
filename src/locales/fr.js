...
typing: 'En train de taper...', thinking: 'Réflexion...', inputPlaceholder: 'Dire quelque chose à {name}...',
...
loadingOlder: 'Chargement des anciens messages...', noMoreHistory: 'Plus de messages', scrollToBottom: 'Aller au dernier', newMessages: 'Nouveaux messages ↓', toolIteration: 'Étape {current}/{max}', toolMore: 'de plus', toolCallArgs: 'Arguments :', toolCallResult: 'Résultat :', toolCallError: 'Erreur :',
  ...
  requirements: {
    ...
    createBtn: 'Nouvelle Exigence',
    noDeptHint: 'Créez d\'abord un département avant d\'ajouter des exigences',
    createTitle: 'Créer une Exigence',
    createFirstBtn: 'Créez Votre Première Exigence',
    stats: { all: 'Toutes', inProgress: 'En cours', completed: 'Terminées', failed: 'Échouées' },
    empty: 'Pas encore d\'exigences',
    emptyHint: 'Cliquez ci-dessus pour créer votre première exigence, ou discutez avec le secrétaire !',
    noMatchTitle: 'Aucune exigence correspondante',
    noMatchHint: 'Essayez d\'ajuster vos mots-clés ou filtres',
    searchPlaceholder: 'Rechercher par titre, description ou département...',
    showingCount: '{n} sur {total} affichés',
    guide: {
      step1Title: 'Créer un Département',
      step1Desc: 'Configurez un département avec les bons membres pour gérer vos tâches.',
      step2Title: 'Créer une Exigence',
      step2Desc: 'Décrivez ce dont vous avez besoin — l\'équipe IA planifiera et exécutera le workflow automatiquement.',
      step3Title: 'Suivre et Réviser',
      step3Desc: 'Surveillez la progression en temps réel, examinez les résultats et approuvez le travail terminé.',
    },
    deptLabel: 'Département',
    deptPlaceholder: 'Sélectionner un département...',
    membersUnit: 'membres',
    titleLabel: 'Titre',
    titlePlaceholder: 'ex. Créer une page d\'accueil pour le nouveau produit',
    descLabel: 'Description',
    descPlaceholder: 'Décrivez l\'exigence en détail — plus de contexte donne de meilleurs résultats...',
    workspaceDirLabel: 'Répertoire de Travail (optionnel)',
    workspaceDirPlaceholder: 'ex. /Users/you/projects/my-app',
    workspaceDirHint: 'Spécifiez un répertoire local pour les opérations de fichiers. Laissez vide pour l\'espace par défaut.',
    browseTitle: 'Parcourir le Répertoire',
    emptyDir: 'Ce répertoire est vide',
    selectDir: 'Sélectionner ce Répertoire',
    creating: 'Création...',
    submitBtn: 'Créer et Lancer',
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', profile: '🎨 Profil', skills: '📚 Compétences', soul: '👻 Âme', work: '📊 Travail', usage: '💰 Consommation', llmLogs: '🔍 Logs LLM', performanceSection: 'Évaluations de performance', taskSection: 'Historique des tâches' },
    soulSections: { memory: '🧠 Mémoire', stamina: '🔋 Endurance', config: '⚙️ Configuration' },
    memorySubTabs: { personal: '💭 Personnel', social: '👥 Relations' },
    avgPerformance: 'Performance moy. {score}', rolePrompt: 'Prompt du Rôle', personalityBio: 'Profil de Personnalité', skills: 'Compétences',
    noSkills: 'Aucune compétence assignée', manageSkills: 'Gérer les compétences',
    skillsDescription: 'Activer ou désactiver les compétences. Les compétences épinglées sont toujours actives.',
    skillPin: 'Épingler', skillUnpin: 'Désépingler', legacySkills: 'Compétences héritées', skillsLoadError: 'Échec du chargement des compétences',
    ...
    providerHint: 'Changez le cerveau IA qui alimente cet employé',
    promptLabel: 'Prompt de rôle',
    promptHint: 'La description du rôle et les instructions qui définissent le travail de cet employé',
    customPromptLabel: 'Instructions personnalisées',
    customPromptPlaceholder: 'Ajoutez des instructions spéciales pour cet employé (ex. « Toujours répondre en français soutenu », « Se concentrer sur les tâches backend »)...',
    customPromptHint: 'Instructions supplémentaires injectées dans le prompt système — affectent la réflexion et les réponses de cet employé',
    ...
    profileName: 'Nom',
    profileNamePlaceholder: 'ex. Alice, Bob',
    avatarStyle: 'Style d\'avatar',
    refreshAvatar: 'Mélanger',
    signatureLabel: 'Signature',
    signaturePlaceholder: 'ex. L\'efficacité c\'est la vie',
    saveProfile: 'Enregistrer le profil',
    profileSaved: 'Profil enregistré !',
    profileSaveFailed: 'Échec de l\'enregistrement du profil',
    llmLogs: {
      empty: 'Aucun journal d\'appels LLM',
      emptyHint: 'En mode développement, les logs sont enregistrés lorsque cet employé effectue des appels LLM',
      totalCount: '{n} entrées',
      refresh: 'Rafraîchir',
      clear: 'Tout effacer',
      clearConfirm: 'Effacer tous les logs LLM de cet employé ? Cette action est irréversible.',
      input: 'Entrée',
      output: 'Sortie',
      toolDefs: 'Définitions d\'outils',
      loadError: 'Échec du chargement des détails du log',
    },
    stamina: {
      noData: 'Aucune donnée d\'endurance disponible',
      comfort: 'Confort',
      patience: 'Patience',
      fatigue: 'Fatigue',
      stress: 'Stress',
      zone_green: 'Normal — fonctionne à pleine capacité',
      zone_yellow: 'Prudence — ajustement de stratégie, énergie en baisse',
      zone_red: 'Critique — besoin de repos ou changement d\'approche',
      formula: 'Confort = Patience - (Fatigue × 0,4 + Stress × 0,6)',
      recentEvents: 'Événements récents',
      noEvents: 'Aucun événement d\'endurance enregistré',
    },
  },
  orgTree: {
  ...
  secretarySettings: {
    ...
    tabProfile: '👤 Profil', tabSoul: '🧠 Âme', tabLLMLogs: '🔍 Logs LLM',
  ...
  reqDetail: {
    ...
    action: {
      analyzingRequirement: '{name} analyse et décompose l\'exigence...',
      analyzingSprint: '{name} analyse et décompose le plan de sprint...',
      bossStop: 'Le boss a demandé l\'arrêt, projet interrompu',
      rePlanning: '{name} replanifie le flux de travail selon les instructions du boss...',
      bossApproved: 'Le boss a approuvé — exigence terminée',
      executionStarted: 'Exécution du flux de travail démarrée',
      preparing: '{name} se prépare à exécuter « {title} »',
      typing: '{name} est en train d\'écrire... « {title} »',
      workingViaCli: '{name} travaille via {backend}... ({elapsed}s écoulées)',
      callingTool: '{name} appelle l\'outil {tool}',
      cliCompleted: '{name} a terminé le travail via {backend} (code de sortie : {exitCode})',
      toolCompleted: '{name} a terminé l\'appel à {tool}',
      typingRound: '{name} est en train d\'écrire... (tour {iteration})',
      reviewing: '{name} examine « {title} » (tour {rounds})',
      revising: '{name} révise « {title} » selon les retours (tour {rounds})',
      revisionCallingTool: '{name} (révision) appelle {tool}',
      revisingIteration: '{name} est en train de réviser... (itération {iteration})',
      revisingAfterDiscussion: '{name} révise « {title} » après discussion (tour {rounds})',
      revisingAfterDiscussionIteration: '{name} révise après discussion... (itération {iteration})',
      allFailed: 'Exécution terminée (toutes les tâches ont échoué)',
      awaitingApproval: 'Toutes les tâches terminées — en attente d\'approbation du boss',
    },
  },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Audit', routing: 'Routage', plugins: 'Plugins', cron: 'Tâches Planifiées', hooks: 'Hooks', sessions: 'Sessions', config: 'Config', skills: 'Compétences', knowledge: 'Base de Connaissances', channels: 'Canaux' },
    ...
    skillStats: { total: 'Total', enabled: 'Activés', categories: 'Catégories', installed: 'Installés', custom: 'Personnalisés' },
    channelStats: { available: 'Disponibles', installed: 'Installés', connected: 'Connectés', messages: 'Messages' },
    channelState: { installed: 'Installé', configured: 'Configuré', connecting: 'Connexion', connected: 'Connecté', disconnected: 'Déconnecté', error: 'Erreur' },
    channelActions: { install: 'Installer', connect: 'Connecter', disconnect: 'Déconnecter', confirmUninstall: 'Êtes-vous sûr de vouloir désinstaller ce canal ?' },
    channelSection: { availableTitle: 'Canaux Disponibles', noAdapters: 'Aucun adaptateur de canal enregistré', guideTitle: 'Guide de Configuration', guideStep1: 'Cliquez sur "Installer" pour le canal souhaité', guideStep2: 'Configurer les paramètres du canal (optionnel)', guideStep3: 'Cliquez sur "Connecter" pour démarrer le canal', guideStep4: 'Pour WeChat : scannez le QR code avec votre téléphone pour vous connecter' },
    channelConfig: { title: 'Configurer {name}', autoReply: 'Répondre automatiquement aux messages' },
qrLogin: { title: 'Connexion WeChat par QR', instruction: 'Scannez le QR code ci-dessous avec WeChat sur votre téléphone pour vous connecter', success: 'Connexion réussie ! WeChat est maintenant connecté.', scanned: 'QR code scanné — veuillez confirmer sur votre téléphone', waiting: 'En attente du scan du QR code...', generating: 'Génération du QR code...', openedInBrowser: 'La page du QR code a été ouverte dans une nouvelle fenêtre. Veuillez scanner avec WeChat.', openQrPage: 'Rouvrir la page du QR code' },
    ...
    skillDetail: { noSkills: 'Aucune compétence', noCustom: 'Aucune compétence personnalisée', noCustomHint: 'Créez des compétences en Markdown pour personnaliser le comportement de l\'agent' },
    skillTabs: { all: 'Toutes', custom: 'Personnalisées', marketplace: 'Marketplace' },
    skillActions: { create: 'Créer', edit: 'Modifier', markdownHint: 'Écrivez en Markdown avec YAML frontmatter (name, description, category, icon, tags)' },
    skillMarketplace: { searchPlaceholder: 'Rechercher sur ClawHub...', install: 'Installer', installed: 'Installé', installedTitle: 'Installés du Marketplace', empty: 'Aucune compétence du marketplace', emptyHint: 'Recherchez sur ClawHub pour découvrir et installer des compétences communautaires' },
  ...
  api: {
    ...
    missingParameter: 'Paramètre requis manquant : {param}',
