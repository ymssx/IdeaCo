...
3. Regularly report department progress to the boss`,
  ...
  providers: {
    ...
    categories: { general: 'General', drawing: 'Dibujo', music: 'Música', video: 'Video' },
  ...
  agent: {
    ...
    toolCalls: '🔧 {n} llamadas de herramienta', score: '{score} pts {level}',
  },
  orgTree: {
  ...
  reqDetail: {
    ...
    workflow: { progress: 'Progreso General', running: 'Ejecutando', completed: 'Completado', failed: 'Fallido', pending: 'Pendiente', typing: 'Trabajando...', notParsed: 'Flujo no analizado' },
