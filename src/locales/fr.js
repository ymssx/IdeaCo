...
stats: { departments: 'Dpts', workers: 'Ouvriers', requirements: 'Exigences' },
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', skills: '📚 Compétences', soul: '👻 Âme', work: '📊 Travail', usage: '💰 Consommation', performanceSection: 'Évaluations de performance', taskSection: 'Historique des tâches' },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Audit', routing: 'Routage', plugins: 'Plugins', cron: 'Tâches Planifiées', hooks: 'Hooks', sessions: 'Sessions', config: 'Config', skills: 'Compétences', knowledge: 'Base de Connaissances' },
