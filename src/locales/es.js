...
stats: { departments: 'Dptos', workers: 'Obreros', requirements: 'Requisitos' },
  ...
  agent: {
    ...
    tabs: { info: '📋 Info', skills: '📚 Habilidades', soul: '👻 Alma', work: '📊 Trabajo', usage: '💰 Consumo', performanceSection: 'Evaluaciones de rendimiento', taskSection: 'Historial de tareas' },
  ...
  systemSettings: {
    ...
    cards: { audit: 'Auditoría', routing: 'Enrutamiento', plugins: 'Plugins', cron: 'Tareas Programadas', hooks: 'Hooks', sessions: 'Sesiones', config: 'Config', skills: 'Habilidades', knowledge: 'Base de Conocimiento' },
