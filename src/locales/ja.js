...
loadingOlder: '古いメッセージを読み込み中...', noMoreHistory: 'これ以上メッセージはありません', scrollToBottom: '最新へ移動', newMessages: '新しいメッセージ ↓', toolIteration: 'ステップ {current}/{max}', toolMore: 'その他', toolCallArgs: '引数:', toolCallResult: '結果:', toolCallError: 'エラー:',
  ...
  agent: {
    ...
    tabs: { info: '📋 基本情報', profile: '🎨 プロフィール', skills: '📚 スキル', soul: '👻 ソウル', work: '📊 仕事', usage: '💰 消費', llmLogs: '🔍 LLMログ', performanceSection: 'パフォーマンス評価', taskSection: 'タスク履歴' },
    ...
    profileName: '名前',
    profileNamePlaceholder: '例：アリス、ボブ',
    avatarStyle: 'アバタースタイル',
    refreshAvatar: 'シャッフル',
    signatureLabel: 'シグネチャー',
    signaturePlaceholder: '例：効率こそ命',
